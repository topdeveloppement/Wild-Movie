...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/film')) {
            // filmpost
            if ($pathinfo === '/filmpost') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::indexAction',  '_route' => 'filmpost',);
            }

            // film
            if ($pathinfo === '/film') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::ShowAction',  '_route' => 'film',);
            }

            // onefilm
            if (preg_match('#^/film/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'onefilm')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::oneItemAction',));
            }
